...
function PanelContainer() {
    return ( <
            ...
            date = "2020 - Present"
            iconStyle = {
                { background: 'rgb(33, 150, 243)', color: '#fff', paddingBottom: 25 } }
            icon = { < FaLaptopCode style = {
                    { marginBottom: 20 } }
                />} >
                <
                h3 className = "vertical-timeline-element-title" > Software Engineer < /h3> <
                h4 className = "vertical-timeline-element-subtitle" > Outcode Software,
                Kathmandu < /h4> <
                p >
                ...
                icon = { < FaLaptopCode style = {
                    ...
                    <
                    h3 className = "vertical-timeline-element-title" > Software Engineer < /h3> <
                    h4 className = "vertical-timeline-element-subtitle" > Insight Workshop,
                    Kathmandu < /h4> <
                    p >
                    High Quality Website and Application <
                    /p> <
